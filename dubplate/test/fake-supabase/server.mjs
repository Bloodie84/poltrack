...
const DB = process.env.FAKE_SUPABASE_DB ?? 'dubplate_e2e';
const STORAGE_DIR = process.env.FAKE_SUPABASE_STORAGE ?? '/tmp/dubplate-storage';
...
const hash = (s) => crypto.createHash('sha256').update(`dubplate:${s}`).digest('hex');
